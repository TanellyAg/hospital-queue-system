# Generated by Django 5.2.14 on 2026-05-15 22:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('doctor_type', models.CharField(choices=[('general', 'General Practitioner'), ('specialist', 'Specialist')], default='general', max_length=20)),
