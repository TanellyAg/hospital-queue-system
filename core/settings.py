...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-hospital-queue-2026-cuib-nene')
...
if os.getenv('USE_LOCAL_DB', 'False') == 'True' or not os.getenv('DB_USER'):
    DATABASES = {
        'default': {
